...
- Only you have access to your imported books

### Reading Progress
- Your reading position and progress are saved locally
- Progress data never leaves your device
- No synchronization with cloud services

### Settings and Preferences
- Font size preferences are stored locally
- App settings remain on your device only
...
Since we don't collect any data, we have nothing to share. Your reading habits, book collection, and progress are yours alone.

## Security

All data remains on your device and is protected by your device's security measures (passcode, Face ID, Touch ID, etc.). We recommend keeping your device secure to protect your personal content.

## Changes to This Privacy Policy

If we make changes to this privacy policy, we will update the "Last Updated" date at the top of this page. Continued use of the app after changes constitutes acceptance of the updated policy.
...
- Open an issue on our GitHub repository: [https://github.com/banjito/Ereader/issues](https://github.com/banjito/Ereader/issues)
- Review our open-source code: [https://github.com/banjito/Ereader](https://github.com/banjito/Ereader)
